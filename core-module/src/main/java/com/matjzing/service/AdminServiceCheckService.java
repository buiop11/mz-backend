...
import com.matjzing.dto.servicecheck.AdminServiceCheckInsertRequest;
...
public class AdminServiceCheckService {
    ...
    public void insertServiceCheck(AdminServiceCheckInsertRequest req, String pw) {
