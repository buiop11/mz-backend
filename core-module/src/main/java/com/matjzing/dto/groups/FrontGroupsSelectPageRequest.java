...
/**
 * 토픽 참여 회원(TOPIC_MEMBER) 페이지 조회 요청
 */
@EqualsAndHashCode(callSuper = false)
@Data
@Schema(description = "토픽 참여 회원 Page 조회 요청")
@Alias("frontGroupsSelectPageRequest")
public class FrontGroupsSelectPageRequest extends PageRequest {
