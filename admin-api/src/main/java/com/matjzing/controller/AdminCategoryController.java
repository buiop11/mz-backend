...
import com.matjzing.service.AdminCategoryService;
...
//		+ "ERR_CATEGORY_001 | 카테고리 List 조회 실패\n"
	...
	public ResponseEntity<ResponseModel<List<AdminCategorySelectListResponse>>> list(AdminCategorySelectListRequest req) {
...
//		+ "ERR_CATEGORY_002 | 카테고리 Page 조회 실패\n"
	...
	public ResponseEntity<ResponseModel<EPageInfo<AdminCategorySelectPageResponse>>> page(AdminCategorySelectPageRequest req) {
...
//		+ "ERR_CATEGORY_003 | 카테고리 상세 조회 실패\n"
	...
	public ResponseEntity<ResponseModel<AdminCategorySelectResponse>> detail(@PathVariable("categorySeq") Long categorySeq, @Parameter(hidden = true) AdminCategorySelectRequest req) {
...
//		+ "ERR_CATEGORY_004 | 카테고리 등록 실패\n"
	...
	public ResponseEntity<ResponseModel<EmptyResponse>> insert(@Valid @RequestBody AdminCategoryInsertRequest req) {
		service.insert(req);
		return RestUtil.ok();
	}
...
//		+ "ERR_CATEGORY_005 | 카테고리 수정 실패\n"
	...
	public ResponseEntity<ResponseModel<EmptyResponse>> update(@Valid @RequestBody AdminCategoryUpdateRequest req) {
		service.update(req);
		return RestUtil.ok();
	}
...
//		+ "ERR_CATEGORY_006 | 카테고리 삭제 실패\n"
	...
	public ResponseEntity<ResponseModel<EmptyResponse>> delete(@PathVariable("categorySeq") Long categorySeq, @Parameter(hidden = true) AdminCategoryDeleteRequest req) {
		service.delete(req);
		return RestUtil.ok();
	}
